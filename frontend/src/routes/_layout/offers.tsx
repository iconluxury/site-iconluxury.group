...
function OffersPage() {
  ...
  const isLocked =
    !currentSubscriptionStatus.hasSubscription &&
    !currentSubscriptionStatus.isTrial
  ...
  const isEffectivelyDeactivated =
    currentSubscriptionStatus.isDeactivated && isLocked
        ...
        <Box>
          ...
          >
            <Table variant="simple" size={{ base: "xs", md: "sm" }}>
              ...
              <Tbody>
                {offersLoading ||
                (isFetching && page === 1 && allOffers.length === 0) ? (
                  <Tr>
                  ...
                  filteredOffers.map((offer) => (
                    ...
                    >
                      ...
                      <Td
                        ...
                        textOverflow="ellipsis"
                        whiteSpace="nowrap"
                        title={offer.userEmail}
                      >
                        {offer.userEmail || "Unknown"}
                      </Td>
                      <Td>
                        {offer.createTime
                          ? new Date(offer.createTime).toLocaleDateString()
                          : "N/A"}
                      </Td>
                      ...
                      <Td>
                        <Badge
                          variant="subtle"
                          colorScheme={getStatusColor(offer.recordCount)}
                          size="sm"
                        >
          ...
          {!hasMore &&
            allOffers.length > 0 && ( // Show "no more" message only if some offers were loaded
              <Box
                h="60px"
                display="flex"
                alignItems="center"
