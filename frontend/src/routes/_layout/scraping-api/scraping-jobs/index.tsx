    ...
    <Container maxW="full" py={6}>
      ...
      <VStack spacing={6} align="stretch">
        ...
        <Box p={6} shadow="md" borderWidth="1px" borderRadius="lg">
          ...
          <Text mb={4}>
            Upload an input file with product data, and our system will scrape
            images and details using the specified API. Track progress and
            download the enriched file once complete.
          </Text>
        </Box>
      </VStack>
    </Container>
